...
const HRHeader = () => {
    ...
    return (
        <header className="hr-header">
            <div className="brand-logo">CUSEC</div>
            ...
            <nav className="nav-links">
                ...
                <NavLink to="/hr-jobs" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
                    <JobsIcon />
                    <span>Jobs</span>
                </NavLink>
                {/* Placeholder links for now */}
                <NavLink to="/hr-queries" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
                    <QueriesIcon />
                    <span>Queries</span>
                </NavLink>
                <NavLink to="/hr-candidates" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
                    <CandidatesIcon />
